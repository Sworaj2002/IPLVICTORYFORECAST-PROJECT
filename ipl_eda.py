...
def app():
    st.markdown(''' 
    <center>―――――――――――――――――――――――――――――――――――――――――――――</center>
    <h1 style='text-align:center;'> EXPLORATORY DATA ANALYSIS ON IPL DATA </h1> 
    <center>―――――――――――――――――――――――――――――――――――――――――――――</center>
...
st.plotly_chart(fig,transparent=True,use_container_width=True)
    ...
    with st.expander('12) Average Runs Scored By Different Teams In Last Over'):
        ...
        ax = sns.barplot(twenty_over_scores.values)
        ax.bar_label(ax.containers[0])
    ...
    with st.expander('16) Count of Matches By Different Umpires'):
        ...
        ax = sns.barplot(top_10_umpires.index)
        ax.bar_label(ax.containers[0])
    ...
    with st.expander('18) Teams With More Than 200+ Scores'):
        ...
        ax = sns.barplot(runs_over_200.index)
        ax.bar_label(ax.containers[0])
        plt.xticks(rotation='vertical')
